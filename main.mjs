...
import * as ipkPanbarlex      from './src/utils/data/ipk-panbarlex.js';
...
export default {vcfFeature, genolinkPassport, ipkPanbarlex, brapiGenotype, germinateGenotype, germinate, promisify};
